               ...
               <div class="flex gap-3">
                  <a href="#" class="block w-full p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800
                     ...
                     <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                        ...
                        {{ ucfirst(auth()->user()->name) }}, the deadline for marking of scripts is exactly one week.
                     </h5>
                  </a>

                  <a href="#" class="block w-full p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800
                      dark:border-gray-700 dark:hover:bg-gray-700">
                     <p class="font-normal text-gray-700 dark:text-gray-400">Average Teaching time.</p>
